...
const IAPSubscriptionAndroid = () => {
                                        ...
                                        >
                                            <Text>
                                                {item?.basePlanId === "monthly"
                                                    ? "Forfait mensuel" :
                                                    item?.basePlanId === "3-month" ? "Forfait trimestriel" : item?.basePlanId}
                                            </Text>
                                            <View style={styles.priceRow}>
                                                ...
                                                <Text>
                                                    {item?.basePlanId === "monthly"
                                                        ? "Mensuel"
                                                        : item?.basePlanId === "3-month" ? "Trimestriel" : item?.basePlanId}
                                                </Text>
                                            </View>
    ...
    }, [subscriptions, activeSubscriptions, is_active]);
    return (
        <View
            style={{
                paddingTop: top,
...
export default IAPSubscriptionAndroid
