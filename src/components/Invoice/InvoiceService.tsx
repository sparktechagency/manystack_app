          ...
          <View key={item.id} style={styles.row}>
            <View style={{
              ...
              <SingleSelectDropDown
                ...
                handler={(text) => {
                  ...
                  const newArray = service.map((s, i) => (i === index ? updatedService : s))
                  setService(newArray);
                }}
                error={error}
              />
            ...
            <View style={[styles.row, {
              ...
              <TouchableOpacity
                ...
                style={{
                  backgroundColor: hexToRGBA(themeColors.primary as string, 0.1), padding: 6, borderRadius: 6
                }}>
                <Image
                  source={Plus as ImageSourcePropType}
                  style={{ width: 20, height: 20, tintColor: themeColors.primary as string, }}
                />
              </TouchableOpacity>
              {
                index !== 0 && <TouchableOpacity
                  ...
                  style={{
                    backgroundColor: hexToRGBA(themeColors.red as string, 0.1), padding: 6, borderRadius: 6
                  }}>
                  <Image
                    source={Close as ImageSourcePropType}
                    style={{ width: 16, height: 16, tintColor: themeColors.red as string, }}
                  />
                </TouchableOpacity>
              }
            </View>
