...
import { FlatList, ImageSourcePropType, SafeAreaView, StyleSheet, View } from 'react-native';
...
const Expanses = () => {
  ...
  const elements = [
    <ProfitCard title="Expanses" count="$23,787" percentage="+14%" icon={Loss as ImageSourcePropType} key={1} />,
